...
class Ui_Dialog(QtGui.QWidget):
	...
	def setupUi(self, Dialog):
		...
		self.apply_btn = QtGui.QPushButton(Dialog)
		...
		self.blacklisted_sites_list = QtGui.QListWidget(Dialog)
		...
		self.blacklisted_sites_label = QtGui.QLabel(Dialog)
		...
		self.blacklisted_sites_editfield = QtGui.QLineEdit(Dialog)
		...
		self.add_blacklisted_sites_btn = QtGui.QPushButton(Dialog)
		...
		self.remove_blacklisted_sites_btn = QtGui.QPushButton(Dialog)
		...
		self.strings_to_modify_label = QtGui.QLabel(Dialog)
		...
		self.strings_to_modify_editfield = QtGui.QLineEdit(Dialog)
		...
		self.strings_to_modify_editfield.setEchoMode(QtGui.QLineEdit.Normal)
		self.strings_to_modify_editfield.setObjectName(_fromUtf8("strings_to_modify_editfield"))
		self.strings_modified_editfield = QtGui.QLineEdit(Dialog)
		...
		self.strings_modified_editfield.setEchoMode(QtGui.QLineEdit.Normal)
		self.strings_modified_editfield.setObjectName(_fromUtf8("strings_modified_editfield"))
		self.remove_strings_to_modify_btn = QtGui.QPushButton(Dialog)
		...
		self.add_strings_to_modify_btn = QtGui.QPushButton(Dialog)
		...
		self.strings_to_modify_list = QtGui.QListWidget(Dialog)
		...
		self.strings_modified_list = QtGui.QListWidget(Dialog)
